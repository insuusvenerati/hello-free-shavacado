...
export const SunIcon = ({ fill = "currentColor", filled, size, height, width, label, ...props }: IconProps) => {
  if (filled) {
    return (
  ...
  return (
    ...
    >
      <path
        ...
        fill={fill}
      ></path>
      <path d="M4.487 17.01H7.487V19.01H4.487z" fill={fill} transform="rotate(-45.017 5.986 18.01)"></path>
      <path d="M16.508 4.99H19.509V6.99H16.508z" fill={fill} transform="rotate(-45.001 18.008 5.99)"></path>
      <path d="M4.487 4.99H7.487V6.99H4.487z" fill={fill} transform="rotate(-134.983 5.988 5.99)"></path>
      <path
